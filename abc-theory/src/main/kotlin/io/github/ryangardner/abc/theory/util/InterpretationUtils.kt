    ...
    fun parseCombinedTransposition(text: String): Int? {
        ...
        val clefShift =
            when {
                ...
                lower.contains("clef=bass") -> -24

                // Standard bass clef shift from treble baseline
                lower.contains("clef=alto") -> -12

                // Standard alto clef shift
                else -> null
            }
        if (clefShift != null) {
...
internal fun NoteDuration.multiply(
    p: Int,
    q: Int,
): NoteDuration = NoteDuration.simplify(this.numerator.toLong() * p, this.denominator.toLong() * q)
