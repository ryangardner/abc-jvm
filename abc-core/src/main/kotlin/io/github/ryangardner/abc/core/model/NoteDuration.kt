...
public data class NoteDuration(
    ...
    public operator fun times(other: NoteDuration): NoteDuration =
        simplify(this.numerator.toLong() * other.numerator, this.denominator.toLong() * other.denominator)

    public fun times(
        num: Int,
        den: Int,
    ): NoteDuration = simplify(this.numerator.toLong() * num, this.denominator.toLong() * den)
