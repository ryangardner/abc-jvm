...
public data class NoteElement
    @JvmOverloads
    constructor(
        public val pitch: Pitch,
        public val durationMultiplier: DurationMultiplier = DurationMultiplier.DEFAULT,
...
public data class ChordElement
    @JvmOverloads
    constructor(
...
public data class BarLineElement
    @JvmOverloads
    constructor(
...
public data class SymbolChord(
    val name: String,
) : SymbolItem

public data class SymbolDecoration(
    val name: String,
) : SymbolItem
...
@Suppress("MaxLineLength")
public data class GraceNoteElement
    @JvmOverloads
    constructor(
        public val notes: List<NoteElement>,
...
public data class BrokenRhythmMarkerElement
    @JvmOverloads
    constructor(
        ...
        override fun withoutLocation(): BrokenRhythmMarkerElement = copy(line = -1, column = -1)
    }
